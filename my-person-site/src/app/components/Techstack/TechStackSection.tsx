...
const TechstackSection: React.FC = () => {
    return (
      <section className="relative flex flex-col items-center text-white py-16 px-4 sm:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-6 sm:mb-8">My <span className='text-purple-500'>Tech Stack</span></h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            {techStack.map((tech, index) => (
              <motion.div
                key={index}
                className="p-4 sm:p-6 bg-neutral-900 rounded-lg shadow-md text-center hover:bg-purple-500 transition group hover:text-white fill-current"
              ...
              >
                ...
                <h3 className="text-xl sm:text-2xl font-semibold text-purple-500 group-hover:text-white transition-all duration-200 ease-in-out">
                  {tech.title}
                </h3>
